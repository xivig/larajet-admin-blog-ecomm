                        ...
                        <div class="collapse navbar-collapse text-center" id="navbarsExample09">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item active">
                                 ...
                                 <li class="nav-item @@contact"><a class="nav-link" href="{{url('/about')}}">About</a></li>
                                ...
                                <li class="nav-item dropdown @@blog">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdown05">
                                        <li><a class="dropdown-item @@blogGrid" href="{{url('/blog-list')}}">Blog Grid</a></li>
                                        <li><a class="dropdown-item @@blogSidebar" href="{{url('/blog')}}">Blog with Sidebar</a></li>
                                        <li><a class="dropdown-item @@blogSingle" href="{{url('/blog-post')}}">Blog Single</a></li>
